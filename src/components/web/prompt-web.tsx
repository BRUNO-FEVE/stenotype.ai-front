...
export default function PromptWeb({
  setCompletion,
  setPrompt,
  prompt,
}: PromptWebProps) {
  ...
  return (
    <div className={`${theme ? 'theme-white' : null} flex-1 flex`}>
      <form
        ...
        className="flex flex-col justify-between pb-7 z-10"
      >
        <Button
        ...
        <ComponentLayout
          label="Modelo :"
          paragraph="You will be able to customize this option soon."
        >
        ...
        <div className="flex flex-col gap-3">
          ...
          />
          <p className="text-sm text-skin-muted italic">
            Higher values tend to make the result more creative and prone to
            possible errors.
          </p>
        </div>
        <ComponentLayout
