  ...
  return (
    <div className='z-10 fixed top-0 right-0 left-0 flex flex-row items-center py-5 px-6 gap-4 [&>*]:text-skin-base justify-between backdrop-blur-sm'>
        ...
        <div className='sm:flex hidden flex-row gap-4 px-6 py-3 rounded-3xl'>
          <Link to={'/documentation'}><button className='text-sm text-skin-muted hover:underline underline-offset-4  hover:text-skin-base duration-100 ease-in'>Documentation</button></Link>
        </div>
        <div className='md:flex hidden flex-row gap-4'>
          ...
          >
            Github
            <Icon Icon={GithubIcon} classname='w-4 h-4 text-skin-base group-hover:text-skin-muted duration-100 ease-in'></Icon>
          </a>
